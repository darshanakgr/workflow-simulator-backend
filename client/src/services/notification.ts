...
export const sendNotification = (notification: Notification) => {
    return (dispatch: Dispatch<{}>) => {
        axios.post("/api/notification", notification).then((res) => {
...
export const getNotifications = () => {
    return (dispatch: Dispatch<{}>) => {
        axios.get("/api/notification").then((res) => {
            ...
            return axios.post("/api/notification/users", {userIds});
        }).then((res) => {
...
export const replyNotification = (id: string, accepted: boolean) => {
    return (dispatch: Dispatch<{}>) => {
        axios.post("/api/notification/reply", {id, accepted}).then((res) => {
