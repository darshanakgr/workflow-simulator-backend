...
class TaskGroup extends React.Component<TaskGroupProps> {
    ...
    handleSave(e: React.FormEvent<HTMLElement>) {
        e.preventDefault();
        const loginForm = findDOMNode(this.refs.newTaskGroupForm) as HTMLFormElement;
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form ref="newTaskGroupForm" onSubmit={this.handleSave.bind(this)}>
                                    <div className="form-group">
                                        <label htmlFor="groupId">Task Group ID</label>
                                        <input ref="groupId"type="text" className="form-control" placeholder="Task Group Id" required />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input ref="description"type="text" className="form-control" placeholder="Description" required />
                                    </div>
